(self["webpackChunksongs"] = self["webpackChunksongs"] || []).push([["utilis_indexDb_cjs"],{
        ...
        switch (_typeof(cat)) {
          ...
          case "string":
            _this.getCategorie(cat)().then(function (r) {
              if (r) {
                var id = r.id;
                _this.updateSong(name, id, newName, verses)().then(resolve).Oups(reject);
              } else {
                resolve(false);
              }
            }).Oups(reject);
        ...
        switch (_typeof(cat)) {
          ...
          case "string":
            _this.getCategorie(cat)().then(function (r) {
              ...
              if (r) {
                var id = r.id;
                _this.deleteSong(name, id)().then(resolve).Oups(reject);
              } else reject();
            }).Oups(reject);
            break;
          default:
        ...
        switch (_typeof(cat)) {
          ...
          case "string":
            _this.getCategorie(cat)().then(function (r) {
              if (r) {
                var id = r.id;
                _this.getSong(name, id)().then(resolve).Oups(reject);
              } else resolve();
            }).Oups(reject);
            break;
          default:
        ...
        switch (_typeof(cat)) {
          ...
          case "string":
            _this.getCategorie(cat)().then(function (r) {
              ...
              if (r) {
                var id = r.id;
                _this.getAllSongs(id)().then(resolve).Oups(reject);
              } else resolve();
            }).Oups(reject);
            break;
          default:
        ...
        switch (_typeof(cat)) {
          ...
          case "string":
            _this.getCategorie(cat)().then(function (r) {
              if (r) {
                var id = r.id;
                _this.countSong(id)().then(resolve).Oups(reject);
              } else resolve();
            }).Oups(reject);
            break;
          default:
...
//# sourceMappingURL=utilis_indexDb_cjs.bundle.js.map